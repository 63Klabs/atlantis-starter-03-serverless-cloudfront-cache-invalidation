...
Property-based tests are **not critical** for this project since the number of CloudFormation templates is controlled and manageable. The focus should be on **fast-running unit tests** that provide quick feedback during development.
