...
- [x] 2. Create path utilities module in Lambda layer
  - [x] 2.1 Implement calculate_path_depth function
    - Calculate depth by counting path segments
    - Handle leading/trailing slashes correctly
    - Return integer count of segments
    - _Requirements: 3.5, 3.6_

  - [x] 2.2 Write property test for path depth calculation
  ...
  - [x] 2.3 Implement matches_pattern function
  ...
  - [x] 2.8 Write unit tests for extract_stage_from_path function
    - Test stage extraction with various patterns
    - Test patterns without {stageId} placeholder
    - Test mismatched patterns and paths
    - _Requirements: 7.1, 7.2, 9.4_

- [x] 3. Update Ingestor function with pattern matching
  - [x] 3.1 Implement should_process_event function
  ...
  - [x] 3.2 Write property test for production stage filtering
  ...
  - [x] 3.3 Write unit tests for should_process_event function
  ...
  - [x] 3.4 Integrate should_process_event into Ingestor handler
    - Call should_process_event for each S3 event
    - Queue events that should be processed
    - Log filtered events at debug level
    - _Requirements: 5.1, 5.2, 5.3, 5.4, 5.5_

- [x] 4. Checkpoint - Ensure Ingestor tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Update Processor function with pattern resolution
  - [x] 5.1 Implement resolve_bucket_pattern function
  ...
  - [x] 5.2 Write unit tests for resolve_bucket_pattern function
  ...
  - [x] 5.3 Implement filter_events_by_pattern function
  ...
  - [x] 5.4 Write unit tests for filter_events_by_pattern function
  ...
  - [x] 5.5 Update consolidate_paths function for dynamic depth
  ...
  - [x] 5.6 Write unit tests for consolidate_paths function
  ...
  - [x] 5.7 Integrate pattern resolution into Processor handler
...
- [x] 6. Checkpoint - Ensure Processor tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. Update CloudFormation template with new parameter
  - [x] 7.1 Add OriginPathPattern parameter
    - Set Type to String
  ...
  - [x] 7.4 Add environment variable mapping to Lambda functions
  ...
  - [x] 7.5 Write unit tests for environment variable mapping
...
- [x] 9. Run backward compatibility tests
