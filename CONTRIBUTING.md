...
While AI-generated code is acceptable, it must be reviewed, understood, and tested by a human before being merged. Kiro is the prefered AI coding assistant as it is in the AWS Ecosystem. Ensure [Kiro steering documents](./.kiro/steering/) are reviewed, understood, and used by both humans and AI. Utilize the Spec-Driven, AI-Assisted Engineering approach and avoid Vibe Coding.
