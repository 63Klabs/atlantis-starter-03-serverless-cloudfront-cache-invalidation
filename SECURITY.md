...
This repository was created using [Atlantis Starter #03](https://github.com/63klabs/atlantis-starter-03-serverless-cloudfront-cache-invalidation) as a template.

### Starter Code

If a developer using the Starter finds a **vulnerability in the code or configuration provided by the starter**, they are encouraged to report it using the [Security and quality](https://github.com/63klabs/atlantis-starter-03-serverless-cloudfront-cache-invalidation/security) section of the original GitHub repository.
