...
pytest tests/integration/test_iam_permissions.py::TestIngestorIAMPermissions::test_ingestor_can_send_to_sqs -v

# Test CloudFront invalidation permission
pytest tests/integration/test_iam_permissions.py::TestProcessorIAMPermissions::test_processor_can_create_invalidation_on_tagged_distribution -v
```
