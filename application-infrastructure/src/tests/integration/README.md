...
pytest src/tests/integration/test_dynamodb_window_tracking.py -v

# End-to-end flow tests
pytest src/tests/integration/test_end_to_end.py -v
```
...
pytest src/tests/integration/test_dynamodb_window_tracking.py::TestWindowCreation -v

# Test only duplicate prevention
pytest src/tests/integration/test_dynamodb_window_tracking.py::TestDuplicateSchedulePrevention -v

# Test only window closure
pytest src/tests/integration/test_dynamodb_window_tracking.py::TestWindowClosure -v
