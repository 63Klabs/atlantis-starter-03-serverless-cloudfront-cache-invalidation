...
pytest src/tests/integration/test_dlq.py::TestDLQMessageMovement -v

# Test only alarm functionality
pytest src/tests/integration/test_dlq.py::TestDLQAlarm -v

# Test only edge cases
pytest src/tests/integration/test_dlq.py::TestDLQEdgeCases -v
```
...
pytest src/tests/integration/test_dlq.py::TestDLQMessageMovement::test_malformed_message_moves_to_dlq -v

# Test alarm triggering
pytest src/tests/integration/test_dlq.py::TestDLQAlarm::test_dlq_alarm_triggers_on_message -v
```
